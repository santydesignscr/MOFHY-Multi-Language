...
$sql = mysqli_query($connect, "UPDATE `hosting_account` SET `account_status` = '0' WHERE `account_username` = '".$_POST['username']."'");
...
$Body = "
	...
	<h2 style='text-align:center;color:skyblue;'><b>Account Suspended</b></h2><hr>
	<h3>Hi ".$ClientInfo['hosting_client_fname'].",</h3><p>We are sorry to say but your acount(".$_POST['username'].") had been suspended due to inactivity or abuse and will be deleted after 60 days.</p><br>
