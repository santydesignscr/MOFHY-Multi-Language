	...
	<div class="card py-0">
		...
		<div class="table-responsive">
			<table class="table table-stripped">
				...
				<tbody>
				<?php
					$sql = mysqli_query($connect,"SELECT * FROM `hosting_clients` ORDER BY `hosting_client_id` DESC");
				...
				?>
					<tr>
						...
						?></td>
						<td><a href="<?php echo $AreaInfo['area_url'];?>admin/viewclient.php?client_id=<?php echo $ClientInfo['hosting_client_key'];?>" class="btn btn-sm btn-<?php
							if($ClientInfo['hosting_client_status'] == 1){
								echo "success text-white";
							} elseif($ClientInfo['hosting_client_status'] == 0){
								echo "secondary";
							}
							else{
								echo "danger";
