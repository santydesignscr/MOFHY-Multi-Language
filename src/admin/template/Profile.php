<div class="container-fluid">
	<div class="card py-20">
		...
		<div class="row">
			...
			?>
			<div class="col-md-6">
				<h6 class="mb-0"><b>Hosting API Username:</b> <pre class='my-0 mr-15' style="overflow-x: auto;"><?php echo $HostingApi['api_username'];?></pre></h6>
			</div>
			<div class="col-md-6">
				<h6 class="mb-0"><b>Hosting API Password:</b> <pre class='my-0 mr-15' style="overflow-x: auto;"><?php echo $HostingApi['api_password'];?></pre></h6>
			</div>
			<div class="col-md-6">
