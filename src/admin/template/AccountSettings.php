	...
	<div class="card py-0">
		...
		<div class="mb-15">
			...
			<form  action="function/DeactivateAccount.php" method="post" onsubmit="
					...
					return true;
				">
				<p class="text-muted mx-10 alert alert-secondary">Before account deactivation you neeed to remove all of your registered domain and subdomain names in order to delete hosting account after that your account will be deleted after 30 days of your account deactivation and all of the account data will be removed completely(This action cannot be undo).</p>
				<div class="mb-10 px-10">
