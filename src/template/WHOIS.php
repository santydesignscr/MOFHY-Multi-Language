<div class="container-fluid">
	<div class="card py-0">
		<div class="d-flex justify-content-between align-items-center pt-15">
			<h5 class="m-0"><?php echo $text['whois_title'];?></h5>
			...
			<div class="row pb-20">
				...
				<div class="col-md-12">
					<div class="mb-5 px-10">
						<button name="submit" id="lookup" class="btn btn-sm btn-primary"><?php echo $text['lookup_whois'];?></button>
					</div>
				</div>
				<div class="col-md-12 mb-10 px-10" style="overflow-x: auto;" id="result"></div>
			</div>
	</div>
</div>
...
$(document).ready(function(){
	...
	var domain = $("#domain").val();
		$.post("function/WHOIS.php", {domain: domain,submit: ""}, function(data){
			$('#hidden-area').html('<div class="alert alert-success" role="alert"><button class="close" data-dismiss="alert" type="button" aria-label="Close"><span aria-hidden="true">&times;</span></button><?php echo $text['lookup_whois_success'];?></div>');
			$("#result").html(data);
		});
	});
});
