<div class="container-fluid">
	<div class="card py-20">
		<div class="d-flex justify-content-between align-items-center ">
			<h5 class="m-0"><?php echo $text['my_porfile_title'];?></h5>
			<a href="<?php echo $AreaInfo['area_url'];?>index.php" class="btn btn-danger btn-sm"><i class="fa fa-backward"></i> <?php echo $text['return'];?></a>
		</div><hr>
		<div class="row">
			<div class="col-md-6">
				<h6 class="mb-0"><b><?php echo $text['my_porfile_first_name'];?></b> <?php echo $ClientInfo['hosting_client_fname'];?></h6>
			</div>
			<div class="col-md-6">
				<h6 class="mb-0"><b><?php echo $text['my_porfile_last_name'];?></b> <?php echo $ClientInfo['hosting_client_lname'];?></h6>
			</div>
			<div class="col-md-6">
				<h6 class="mb-0"><b><?php echo $text['my_porfile_email_address'];?></b> <?php echo $ClientInfo['hosting_client_email'];?></h6>
			</div>
			<div class="col-md-6">
				<h6 class="mb-0"><b><?php echo $text['my_porfile_phone'];?></b> <?php echo $ClientInfo['hosting_client_phone'];?></h6>
			</div>

			<div class="col-md-6">
				<h6 class="mb-0"><b><?php echo $text['my_porfile_address'];?></b> <?php echo $ClientInfo['hosting_client_address'];?></h6>
			</div>
			<div class="col-md-6">
				<h6 class="mb-0"><b><?php echo $text['my_porfile_company'];?></b> <?php echo $ClientInfo['hosting_client_company'];?></h6>
			</div>
			<div class="col-md-6">
				<h6 class="mb-0"><b><?php echo $text['my_porfile_country'];?></b> <?php 
					$countries = array(
			...
			<div class="col-md-6">
				<h6 class="mb-0"><b><?php echo $text['my_porfile_city'];?></b> <?php echo $ClientInfo['hosting_client_city'];?></h6>
			</div>
			<div class="col-md-6">
				<h6 class="mb-0"><b><?php echo $text['my_porfile_postal_code'];?></b> <?php echo $ClientInfo['hosting_client_pcode'];?></h6>
			</div>
			<div class="col-md-6">
				<h6 class="mb-0"><b><?php echo $text['my_porfile_ip'];?></b> <?php echo UserInfo::get_ip();?></h6>
			</div>
			<div class="col-md-6">
				<h6 class="mb-0"><b><?php echo $text['my_porfile_device_type'];?></b> <?php echo UserInfo::get_device();?></h6>
			</div>
			<div class="col-md-6">
				<h6 class="mb-0"><b><?php echo $text['my_account_device_os'];?></b> <?php echo UserInfo::get_os();?></h6>
			</div>
			<div class="col-md-6">
				<h6 class="mb-0"><b><?php echo $text['my_account_web_browser'];?></b> <?php echo UserInfo::get_browser();?></h6>
			</div>
			<div class="col-md-12">
