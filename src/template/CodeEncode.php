<div class="container-fluid">
	<div class="card py-0">
		<div class="d-flex justify-content-between align-items-center pt-15">
			<h5 class="m-0"><?php echo $text['code_encode_title'];?></h5>
		...
		<hr>
			<div class="row pb-20">
				...
				<div class="col-md-12">
					<div class="mb-10 px-10">
						<label class="form-label required"><?php echo $text['code'];?></label>
						<textarea name="csr" style="height: 250px" placeholder="<?php echo $text['code_place'];?>" class="form-control" id="css_code" required></textarea> 
					</div>
				</div>
				<div class="col-md-12">
					<div class="mb-5 px-10">
						<button name="submit" id="minify" class="btn btn-sm btn-primary"><?php echo $text['encode'];?></button>
					</div>
				</div>
...
$(document).ready(function(){
	...
	var code = $("#css_code").val();
		$.post("function/CodeEncode.php", {code: code,submit: ""}, function(data){
			$('#hidden-area').html('<div class="alert alert-success" role="alert"><button class="close" data-dismiss="alert" type="button" aria-label="Close"><span aria-hidden="true">&times;</span></button><?php echo $text['encode_success'];?></div>');
			$("#result").html(data);
		});
	});
});
