			...
			<div class="col-md-12">
				...
				<?php 
					if($ClientInfo['hosting_client_status']=='0'){
						echo '<a href="function/Activate.php?client_id='.$ClientInfo['hosting_client_key'].'" class="btn m5t btn-sm btn-success">Mark as Active</a>';
					} elseif($ClientInfo['hosting_client_status']=='1'){
						echo '<a href="function/Suspend.php?client_id='.$ClientInfo['hosting_client_key'].'" class="btn m5t btn-sm btn-secondary">Mark as Suspended</a>';
