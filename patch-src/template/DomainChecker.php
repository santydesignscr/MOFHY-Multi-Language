<div class="container-fluid">
	<div class="card py-0">
		<div class="d-flex justify-content-between align-items-center pt-15">
			<h5 class="m-0"><?php echo $text['domain_checker'];?></h5>
			...
			<div class="row pb-20">
				...
				<div class="col-md-12">
					<div class="mb-5 px-10">
						<button name="submit" id="check" class="btn btn-sm btn-primary"><?php echo $text['check_domain'];?></button>
					</div>
				</div>
				<div class="col-md-12 mb-10 mx-10" id="result"></div>
			</div>
	</div>
</div>
...
$(document).ready(function(){
	...
	var domain = $("#domain").val();
		$.post("function/DomainChecker.php", {domain: domain,submit: ""}, function(data){
