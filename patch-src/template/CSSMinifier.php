<div class="container-fluid">
	<div class="card py-0">
		<div class="d-flex justify-content-between align-items-center pt-15">
			<h5 class="m-0"><?php echo $text['minify'];?></h5>
			...
			<div class="row pb-20">
				...
				<div class="col-md-12">
					<div class="mb-5 px-10">
						<button name="submit" id="minify" class="btn btn-sm btn-primary"><?php echo $text['minify'];?></button>
					</div>
				</div>
...
$(document).ready(function(){
	...
	var css = $("#css_code").val();
		$.post("function/CSSMinifier.php", {css: css,submit: ""}, function(data){
			$('#hidden-area').html('<div class="alert alert-success" role="alert"><button class="close" data-dismiss="alert" type="button" aria-label="Close"><span aria-hidden="true">&times;</span></button><?php echo $text['minify_success'];?></div>');
			$("#result").html(data);
		});
	});
});
